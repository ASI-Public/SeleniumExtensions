...
namespace ASI.SeleniumExtensions
{
  ...
  public class SearchableDocumentTests
  {
    ...
    public void FindElement_ByClassName_OneElement()
    {
      // Arrange
      const string document =
        "<!DOCTYPE html><html><head><title class=\"elementClass\">Page Title</title></head><body><h1>This is a Heading</h1><p>This is a paragraph.</p></body></html> ";
      var searchableDocument = new SearchableDocument(document);
    ...
    public void FindElement_ById_OneElement()
    {
      // Arrange
      const string document =
        "<!DOCTYPE html><html><head><title id=\"elementId\">Page Title</title></head><body><h1>This is a Heading</h1><p>This is a paragraph.</p></body></html> ";
      var searchableDocument = new SearchableDocument(document);
    ...
    public void FindElement_ByName_NoElements()
    {
      // Arrange
      const string document =
        "<!DOCTYPE html><html><head><title name=\"elementName\">Page Title</title></head><body><h1>This is a Heading</h1><p>This is a paragraph.</p></body></html> ";
      var searchableDocument = new SearchableDocument(document);
    ...
    public void FindElement_ByXPathNestedType_OneElement()
    {
      ...
      const string document =
        "<!DOCTYPE html><html><head><title>Page Title</title></head><body><h1>This is a Heading</h1><title id=\"correctTitle\">Page Title</title><p>This is a paragraph.</p></body></html> ";
      var searchableDocument = new SearchableDocument(document);
    ...
    public void FindElement_ByXPathTypeAndIndex_OneElement()
    {
      ...
      const string document =
        "<!DOCTYPE html><html><head><title>Page Title</title></head><body><h1>This is a Heading</h1><title id=\"correctTitle\">Page Title</title><p>This is a paragraph.</p><p>This is another paragraph.</p></body></html> ";
      var searchableDocument = new SearchableDocument(document);
